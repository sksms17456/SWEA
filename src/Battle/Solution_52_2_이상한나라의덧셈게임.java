...
public class Solution_52_2_이상한나라의덧셈게임 {
...
//		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		...
		for(int t=1; t<=T; t++) {
			...
			while(true) {
				...
				Arrays.sort(newline);
				line = String.copyValueOf(newline);
				
				int sum = (newline[0]-'0')+(newline[1]-'0');
				
				if(len>2) {
					String str = line.substring(2,len);
					line = new String(sum+str);
				}else {
					line = new String(""+sum);
				}
			}
