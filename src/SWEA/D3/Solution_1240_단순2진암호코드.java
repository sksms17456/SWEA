...
public class Solution_1240_단순2진암호코드 {
	...
	public static void main(String[] args) throws Exception{
		...
		BufferedReader br = new BufferedReader(new FileReader("text_D3/Solution_1240_단순2진암호코드.txt"));
//		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		...
		for(int t=1; t<=T; t++) {
			...
			for(int i=0; i<N; i++) {
				if(isFind) {
					...
					if(idx==-1)
						...
						while(cnt<8) {
							sb.append(map.get(str.substring(idx-6, idx+1)));
							cnt++;
							idx -= 7;
							isFind = true;
						}
			...
			int val = (sb.charAt(1)-'0'+sb.charAt(3)-'0'+sb.charAt(5)-'0'+sb.charAt(7)-'0')*3;
			int val2 = sb.charAt(2)-'0'+sb.charAt(4)-'0'+sb.charAt(6)-'0';
			int verf = sb.charAt(0)-'0';
			if((val+val2+verf)%10 == 0) {
				for(int k=0; k<sb.length(); k++) {
					answer+=sb.charAt(k)-'0';
				}
			}
